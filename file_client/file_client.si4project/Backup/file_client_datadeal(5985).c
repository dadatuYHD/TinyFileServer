...
int datadeal_file_list(int i_connect_fd)
{
    ...
    if (gst_test_hdr.en_module == MODULE_TEST_PROTO)
    {
        ...
        /*pading the gst_test_hdr structure*/
		gst_test_hdr.en_version = 1;
		gst_test_hdr.ui_dat_len = i_pack_len;
		gst_test_hdr.us_hdr_len = sizeof(gst_test_hdr);

		/*sned the gst_test_hdr*/
        i_ret = client_send_data(i_connect_fd, (char *)&gst_test_hdr, sizeof(gst_test_hdr));
